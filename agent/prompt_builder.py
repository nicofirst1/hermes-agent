...
OPENAI_MODEL_EXECUTION_GUIDANCE = (
    ...
    "- A terse empty result (e.g. {\"total_count\": 0} or []) is still a real "
    "result: the tool executed and found nothing. Never interpret a "
    "structurally valid result as a lost message, an empty prompt, or a "
    "delivery failure — proceed on the data (treat as 'not found', broaden "
    "the query, or continue to the next step).\n"
    "- If a result genuinely looks malformed, say what was malformed and "
    "retry or continue with the next step; do not stop to ask what to do.\n"
    "</tool_result_interpretation>\n\n"
    "<mandatory_tool_use>\n"
